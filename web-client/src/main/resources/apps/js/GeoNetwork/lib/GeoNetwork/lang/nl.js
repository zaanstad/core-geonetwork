...
GeoNetwork.Lang.nl = {
    ...
    'updateUserInfo': 'Wijzig profiel',
    'updatePassword': 'Wijzig wachtwoord',
    'myMetadata': 'Mijn metadata',
    '_owner': 'Gebruiker id',
    '_isHarvested': 'Harvested records',
    'templates': 'Metadata templates',
    'myDraft': 'Draft metadata',
    'QuickSearch': 'Snel zoeken',
    'LastSubmitted': 'Laatst ingediend',
    'lastUpdates': 'Laatste wijziging',
    '_indexingError': 'Index error',
    'RecordWithIndexingError': 'Records met een index error',
    'fromLocalCatalog': 'Metadata uit de locale catalogus',
    'fromHarvestedCatalog': 'Metadata van geharveste catalogi',
    'dateType': 'Datum type',
    ...
    'metadataPOC': 'metadata contactpunt',
    'metadataPOCs': 'Metadata contactpunt',
    ...
    'rules': 'rules',
    'rule': 'rule',
    'schematron-rules-geonetwork': 'GeoNetwork validatie',
    'schematron-rules-iso': 'ISO validatie',
    'schematron-rules-inspire': 'INSPIRE validatie',
    'to-iso19139-keyword': 'Tekst mode',
    'to-iso19139-keyword-as-xlink': 'Gelinkte mode',
    'to-iso19139-keyword-with-anchor': 'Anker mode',
    'linklabel-application/vnd.ogc.wms_xml': 'Voeg toe aan kaart',
    'linklabel-application/vnd.ogc.wmc': 'Interactieve kaart',
    ...
    'createThesaurus': 'Thesaurus aanmaken',
	'Online data': 'Webservice',
	'Data for download': 'Downloads'
};
